...
argparser.add_argument('--ami', help='e.g. ami-12345678', default="ami-12345678")
...
params = {"product": args.product, "version": args.version, "region": args.region, "ami": args.ami, "arch": args.arch, "itype": args.itype, "ec2name": args.ec2name, "virtualization": args.virtualization, "memory": args.memory}

con = patchwork.connection.Connection({"public_hostname": args.host, "private_hostname": args.host}, username=args.user, key_filename=args.key)
